...
namespace CZParser {
    internal class PatternBank {
        ...
        private static List<string> termPatterns = new List<string> { "Tx,Tq,Tp", "Tx,Tp,Tq", "Tx,Tp,Th", "Tf,To", "Tp,Tw", "Tp, Tx", "Tp,Th", "Tp,Tq,Th", "Tx,Tq,A", "Ta,Td", "Tp,Th,Tx", "Tq,Tp", "Tx,Tx,Tq,Tp"};
